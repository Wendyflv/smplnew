...
class ArgManager:
    def __init__(self, manual_args=None):
        ...
        parser.add_argument("--device", default='cpu', help="Training device, has to be cuda")

        # training
        parser.add_argument('--num_epochs', type=int, default=50, help='Total number of training epochs')
        ...
        parser.add_argument('--eval_epochs', type=int, default=2, help='Evaluation frequency')
        parser.add_argument('--joint_criterion', type=str, default='mse', help='L1 or mse')

        # model
        parser.add_argument('--model_type', type=str, default='smpler', help='Model: backbone or smpler')
        ...
        # others
        parser.add_argument('--data_mode', type=str, default='3dpw', help='Dataset: h36m or 3dpw')
        ...
        parser.add_argument('--checkpoint-dir', type=str, default='./checkpoints', help='Directory to save or load checkpoints')
        parser.add_argument('--save-interval', type=int, default=2, help='Save model checkpoint every X epochs')
